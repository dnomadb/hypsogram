...
L.mapbox.accessToken = 'pk.eyJ1IjoiZG5vbWFkYiIsImEiOiJjbGdsOHRpYWcxbWxwM3NueWYwYWYwbms0In0.zb8hlW2-BNebPuQ2hhiAuw';
...
map.on('mousemove', function(e) {
    ...
    elevWorker.postMessage({'data':latlng,'type':'mousemove'});
})
...
elevWorker.addEventListener('message', function(response) {
    ...
    } else if (response.data.type === 'mousemove') {
        console.log('ELEVATION: ' + response.data.data.elev + ' M')
    }
}, false);
